...
//
// İkinci Kısım'ın kalan bölümleri ("B) Taşıyıcının Sorumluluğu",
// m.875-893, ve araya giren "C-D" alt kısımları, m.862-874), "Üçüncü
// Kısım - Taşınma Eşyası" (m.894-901), "Dördüncü Kısım - Değişik Tür
// Araçlarla Taşıma" (m.902-905), "Beşinci Kısım - Yolcu Taşıma"
