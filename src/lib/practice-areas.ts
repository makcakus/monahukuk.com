...
export const PRACTICE_AREAS: PracticeArea[] = [
  {
    ...
    description: {
      ...
      fr: "Nous gérons l'ensemble des procédures juridiques pour les ressortissants étrangers souhaitant résider, travailler ou créer une entreprise en Turquie. Nos avocats expérimentés en immigration à Antalya accompagnent dans les demandes de permis de séjour, les procédures de permis de travail, les recours contre les refus de visa et la défense contre les décisions d'expulsion.",
    },
  },
  {
    slug: "gayrimenkul",
  ...
  },
  {
    ...
    description: {
      ...
      es: "Asesoramos sobre el cumplimiento de la KVKK (Ley turca de protección de datos personales), disputas de licencias de software, casos de violación de datos y los aspectos legales de las tecnologías de inteligencia artificial en Turquía. Con soporte jurídico en derecho TI para empresas tecnológicas y startups, aseguramos su transformación digital.",
  ...
  },
  {
    ...
    description: {
      ...
      es: "Asistimos a propietarios e inquilinos en disputas de arrendamiento, redacción y revisión de contratos de arrendamiento, procedimientos de desahucio y casos de determinación o ajuste de rentas. Proporcionamos apoyo a inquilinos extranjeros y propietarios en Antalya para un proceso de arrendamiento legalmente seguro.",
