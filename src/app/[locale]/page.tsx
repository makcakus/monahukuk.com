      ...
      <section className="border-t border-cream-200">
        <div className="mx-auto max-w-6xl px-6 py-20 grid gap-8 md:grid-cols-12 items-center">
          ...
          <div className="md:col-span-4 md:text-end">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center gap-2 rounded-sm bg-gold-500 px-6 text-sm font-medium text-navy-950 hover:bg-gold-600 transition-colors whitespace-nowrap w-full sm:w-auto h-[48px] flex-shrink-0"
            >
