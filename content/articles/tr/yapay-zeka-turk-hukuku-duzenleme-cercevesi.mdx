---
title: "Yapay Zekâ ve Türk Hukuku: Düzenleme Çerçevesi Rehberi"
description: "Türkiye'de yapay zekâ uygulamalarının hukuki çerçevesi, sorumluluk, telif hakkı ve KVKK boyutu. Antalya yapay zekâ hukuku alanında işletmeler için analiz."
date: 2026-04-28
...
- Türkiye'de yapay zekâya özgü **münhasır bir kanun henüz yürürlükte değildir**; mevcut çerçeve KVKK, telif ve haksız fiil hükümlerinden oluşur.
- Model eğitimi için kişisel veri işlenmesi, KVKK kapsamında bir **hukuki sebebe** dayanmalıdır.
- Tamamen otomatik bir sistem ilgili kişi aleyhine karar veriyorsa, KVKK bu karara itiraz ve **insan müdahalesi** talep etme hakkı tanır.
- Yapay zekânın yol açtığı zararlar Türk hukukunda **haksız fiil sorumluluğu** çerçevesinde değerlendirilir.
...
Hayır, bu metnin yazıldığı tarih itibarıyla yapay zekâya ilişkin münhasır bir kanun yürürlüğe girmemiştir. Uygulama, mevcut mevzuat üzerinden yürür: kişisel veri boyutunda **KVKK**, çıktılar ve eğitim verisi boyutunda **telif mevzuatı**, zararlar bakımından **haksız fiil** hükümleri.

### Yapay zekânın verdiği kararlara itiraz edebilir miyim?

Evet. Tamamen otomatik bir sistem ilgili kişi aleyhine bir karar veriyorsa — kredi başvurusunun reddi veya iş başvurusunun ön elenmesi gibi — KVKK ilgili kişiye bu karara **itiraz etme ve insan müdahalesi talep etme** hakkı tanır.

### Chatbot kullanırken müşteriyi bilgilendirmek zorunda mıyım?

Evet. Müşterinin bir **bot ile konuştuğunu bilme hakkı** vardır. Ayrıca botun verdiği bilgilerin doğruluğu ve bunlardan doğacak sorumluluk, sözleşmesel olarak açıkça düzenlenmelidir.
