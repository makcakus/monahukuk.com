...
- Ticari sözleşmelerde en sık rastlanan hata, işe ve tarafa uyarlanmamış standart şablon kullanmaktır.
- Ödeme şartlarının belirsiz bırakılması (muğlak 'iş tamamlanınca ödenir' ifadeleri, faturalandırma anının ve temerrüt sonuçlarının yazılmaması) ihtilafların başlıca kaynağıdır.
- Teslim tarihi ve kabul prosedürünün eksik düzenlenmesi, ayıptan doğan sorumluluğun ne zaman başladığını tartışmalı hâle getirir.
- Sorumluluk sınırlamalarının tek yanlı olması, güçlü tarafın lehine orantısız bir risk dağılımı yaratır.
- Süresiz veya otomatik yenilenen sözleşmeler şirketi bağlar; fesih mekanizması ve bildirim süresi mutlaka yazılmalıdır.
- Gizlilik, fikrî mülkiyet sahipliği ve uyuşmazlık çözümü (yetkili mahkeme, tahkim, uygulanacak hukuk) hükümlerinin ihmali, uyuşmazlık çıktığında en pahalı eksikliklerdir.
...
### Ticari sözleşmede en sık yapılan hata nedir?

İşe uyarlanmamış <b>standart şablon</b> kullanmak. İnternetten indirilen veya başka bir işten alınan bir metin, tarafların gerçek edim yapısını, risk dağılımını ve sektöre özgü zorunlulukları yansıtmaz. Uyuşmazlık çıktığında en çok tartışılan noktalar tam da şablonda boş bırakılan veya kopyalanan kalemlerdir: ödeme koşulları, teslim ve kabul, sorumluluk sınırı, fesih ve yetkili mahkeme.

### Ödeme şartları nasıl yazılmalıdır?

Somut ve ölçülebilir biçimde. Muğlak 'iş tamamlanınca ödenir' ifadeleri yerine; <b>işin tamamlanma kriteri</b>, <b>faturanın hangi olaydan sonra kaç gün içinde düzenleneceği</b>, <b>ödeme vadesi</b>, <b>gecikme faizi oranı</b> ve <b>temerrüdün sonuçları</b> ayrı ayrı yazılmalıdır. Taraflar tacirse TTK m.8 uyarınca <b>faiz oranı serbestçe belirlenir</b>; ancak bu serbestiden yararlanmak için oranın sözleşmede açıkça kararlaştırılmış olması gerekir.

### Sorumluluk sınırlaması sözleşmeye konulabilir mi?

Kural olarak evet, ama sınırları vardır. TBK m.115 uyarınca <b>borçlunun ağır kusurundan sorumlu olmayacağına ilişkin önceden yapılan anlaşma kesin olarak hükümsüzdür</b>; hizmet, uzmanlık gerektiren bir faaliyet veya izne bağlı bir meslek söz konusuysa hafif kusur için yapılan sınırlama da hükümsüz sayılabilir. Ayrıca TTK m.854 uyarınca taşıma hukukunda, m.1243 uyarınca deniz taşımasında sorumluluğu önceden kaldıran veya daraltan kayıtlar geçersizdir.
