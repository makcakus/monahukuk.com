...
- Çatılı işyeri kirası, üstü kapalı ve ticari ya da mesleki amaçla kullanılan taşınmazların kiralanmasını kapsar.
- Kira artışı, konut kirasında olduğu gibi **TÜFE oranıyla** sınırlıdır (TBK m.344).
- Kiracı, bir kira yılında iki kez temerrüde düşer ve her defasında usulüne uygun ihtar gönderilirse, kira süresinin bitiminden itibaren **1 ay** içinde tahliye davası açılabilir (TBK m.352/2).
- Haksız tahliyede ticari kiracı, taşınma masraflarının ötesinde **ticari kazanç kaybı** da talep edebilir.
- Sözleşmede kullanım amacının açıkça belirtilmesi, sonraki uyuşmazlıkları önleyen en kritik hükümdür.
...
- **Tahliye taahhüdünün geçersizliği**: Yargıtay İçtihadı Birleştirme Kurulu'nun 04.10.1944 tarihli, E. 1944/20, K. 1944/28 sayılı kararı uyarınca, kira sözleşmesiyle birlikte veya sözleşmenin ön şartı olarak alınan tahliye taahhütnameleri serbest iradeye dayanmadığından geçersiz sayılır; bu ilke Yargıtay Hukuk Genel Kurulu'nun 28.09.2021 tarihli, E. 2017/975, K. 2021/1108 sayılı kararında da teyit edilmiştir.
...
### İşyeri kirasında kira artışı sınırlı mıdır?

Evet. İşyeri kiralarında da kira artışı TBK m.344 çerçevesinde **TÜFE oranıyla** sınırlandırılmıştır; bu sınır konut kirasındakiyle aynıdır.

### İki haklı ihtar nedeniyle tahliye hangi şartlarda mümkündür?

Kiracı bir kira yılı içinde kira bedelini **iki kez** ödemekte temerrüde düşmüş ve kiraya veren her defasında yasal süreye uygun ihtarname göndermiş olmalıdır. Bu şartlar gerçekleşirse kiraya veren, kira süresinin bitiminden itibaren **1 ay** içinde tahliye davası açabilir (TBK m.352/2).

### Haksız tahliye edilen ticari kiracı hangi zararları isteyebilir?

Ticari kiracı, salt taşınma masraflarıyla sınırlı kalmaz; kira ilişkisinin erken sona ermesinden kaynaklanan **ticari kazanç kaybını** da talep edebilir. Bu, işyeri kirasını konut kirasından ayıran en önemli farklardan biridir.
