---
title: "Erreurs fréquentes dans les contrats commerciaux en Turquie"
...
### Quelle est l'erreur la plus fréquente dans les contrats commerciaux ?

Recourir à un <b>modèle standard</b> non adapté à l'opération. Un texte téléchargé sur internet ou repris d'une autre affaire ne reflète ni la structure réelle des prestations, ni la répartition des risques, ni les exigences propres au secteur. En cas de litige, les points les plus discutés sont précisément les postes laissés en blanc ou recopiés : conditions de paiement, livraison et réception, plafond de responsabilité, résiliation et juridiction compétente.

### Comment rédiger les conditions de paiement ?

De manière concrète et mesurable. Au lieu d'un vague « payable à l'achèvement des travaux », il faut préciser séparément <b>le critère d'achèvement</b>, <b>l'événement après lequel la facture est émise et dans quel délai</b>, <b>l'échéance de paiement</b>, <b>le taux des intérêts moratoires</b> et <b>les conséquences du retard</b>. Si les deux parties sont commerçantes, <b>le taux d'intérêt est librement fixé</b> selon l'article 8 ; mais pour user de cette liberté, le taux doit être expressément convenu.

### Une limitation de responsabilité peut-elle figurer au contrat ?

En principe oui, mais dans certaines limites. Selon l'article 115 du Code des obligations, <b>la convention conclue d'avance selon laquelle le débiteur ne répondra pas de sa faute lourde est absolument nulle</b> ; s'il s'agit d'un service, d'une activité exigeant une compétence particulière ou d'une profession soumise à autorisation, la limitation peut être nulle même pour la faute légère. De plus, selon l'article 854 en droit des transports et l'article 1243 en transport maritime, les clauses excluant ou réduisant par avance la responsabilité sont sans effet.
