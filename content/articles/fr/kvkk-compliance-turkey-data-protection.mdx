---
title: "Conformité KVKK : Protection des Données en Turquie"
description: "Conformité KVKK : inscription au VERBİS, consentement explicite, politique de confidentialité et notification de violation."
date: 2026-04-28
...
### Quelles entreprises la KVKK couvre-t-elle ?

La loi turque sur la protection des données personnelles (KVKK) couvre <b>toutes les personnes physiques et morales</b> qui traitent des données personnelles ; il n'existe aucune exemption selon la taille de l'entreprise. Constitue une donnée personnelle toute information se rapportant à une personne physique identifiée ou identifiable.

### Suis-je tenu de m'inscrire à VERBİS ?

Les responsables de traitement dépassant une certaine taille doivent s'inscrire au <b>système d'information du registre des responsables de traitement (VERBİS)</b>. Ceux qui y sont tenus doivent en outre établir une <b>politique de conservation et de destruction des données personnelles</b>.

### Que faire en cas de violation de données ?

En cas de violation de données telle qu'une cyberattaque ou une fuite, le responsable de traitement doit <b>en informer l'Autorité dans les meilleurs délais</b> et <b>avertir les personnes concernées</b>.
