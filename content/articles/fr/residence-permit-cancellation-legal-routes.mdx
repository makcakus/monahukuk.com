---
title: "Annulation d'un titre de séjour en Turquie"
description: "Titre de séjour annulé en Turquie : recours administratif, sursis à exécution et stratégies de défense pour les étrangers."
date: 2026-04-28
...
### Dans quelles circonstances un titre de séjour est-il annulé ?

Les principaux motifs sont : la disparition de la cause sur laquelle reposait le titre ; le défaut de renouvellement d'un titre dont la durée a expiré ; un séjour prolongé à l'étranger ; une fausse déclaration ou un document falsifié dans la demande ; un casier judiciaire d'une certaine gravité ; des motifs d'ordre public ou de sécurité ; et, pour le titre de séjour familial, la constatation que le mariage n'est pas authentique.

### Si je divorce, mon titre de séjour est-il automatiquement annulé ?

Le titre de séjour familial reposant sur l'union matrimoniale, la dissolution du mariage fait disparaître la condition sur laquelle il était fondé et constitue une cause d'annulation. Il convient donc d'examiner tôt, pendant la procédure de divorce, les autres types de titres possibles.

### Que se passe-t-il si je ne renouvelle pas mon titre ?

Le défaut de renouvellement d'un titre de séjour dont la durée a expiré constitue une <b>cause automatique d'annulation</b>. Déposer la demande de renouvellement dans les délais évite des conséquences difficiles à corriger par la suite.
