...
En Turquie, les logiciels — qu'il s'agisse du code source ou du code compilé — sont protégés en tant qu'œuvres littéraires et scientifiques par la loi n° 5846 sur les œuvres intellectuelles et artistiques (*Fikir ve Sanat Eserleri Kanunu*, ou FSEK).

Sur la question de la paternité, l'article 8 de la FSEK attribue la qualité d'auteur à la personne qui a créé l'œuvre. Lorsqu'un développeur est salarié, l'employeur acquiert en principe le droit d'exploitation du logiciel créé dans le cadre de ce travail, sauf disposition contraire expresse (article 18, alinéa 2). Dans les contrats de développement indépendant — modèle courant en Turquie —, le transfert des droits doit être expressément convenu par écrit conformément à l'article 52 de la FSEK. Un accord verbal ou une cession implicite ne suffit pas.

Pour l'accord d'escrow, cela signifie que le contrat doit préciser clairement ce que reçoit le séquestre : la propriété sur le code, une licence conditionnelle ou simplement un droit d'accès au déclenchement de l'événement prévu. L'article 68 de la FSEK prévoit également une indemnisation équivalente au triple du montant de la redevance convenue en cas d'atteinte aux droits d'auteur — un outil dissuasif important en cas de litige. Pour aller plus loin, nos articles sur les [risques des contrats de licence logicielle en Turquie](/fr/articles/software-license-agreements-legal-risks) et sur la [conformité KVKK en matière de protection des données](/fr/articles/kvkk-compliance-turkey-data-protection) complètent utilement cette lecture.
...
Le client peut demander l'exécution forcée et des dommages et intérêts par voie judiciaire. L'article 68 de la FSEK accorde en outre une indemnisation équivalente au triple de la redevance convenue lorsque des droits d'auteur sont violés. À Antalya, les litiges en propriété intellectuelle sont traités par des tribunaux de commerce spécialisés.
