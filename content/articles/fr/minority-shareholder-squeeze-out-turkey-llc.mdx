...
La protection la plus efficace se construit avant que le conflit n'émerge. Lors de la [constitution d'une société en Turquie](/fr/articles/yabanci-yatirimci-turkiyede-sirket-kurma) ou lors de l'acquisition d'une participation minoritaire dans une [société existante](/fr/articles/anonim-sirket-vs-limited-sirket-secim), négociez l'inclusion des mécanismes de protection suivants dans les statuts ou dans un pacte d'associés distinct :
...
Ces clauses sont juridiquement contraignantes en Turquie lorsqu'elles sont correctement rédigées. La [bonne rédaction des contrats commerciaux](/fr/articles/ticari-sozlesmelerde-sikca-yapilan-hatalar) est fondamentale ; les clauses mal formulées sont fréquemment invalidées par les tribunaux.
