...
### Quelle différence entre reconnaissance et exequatur ?

La <b>reconnaissance</b> signifie que le jugement étranger acquiert en Türkiye l'autorité de la chose jugée ; elle suffit pour les jugements d'état comme un divorce. L'<b>exequatur</b> signifie que le jugement devient exécutoire en Türkiye et il est nécessaire pour recouvrer une créance par voie d'exécution forcée.

### Devant quelle juridiction l'action en exequatur est-elle portée ?

Devant le tribunal civil de première instance. La compétence territoriale se détermine dans cet ordre : domicile du défendeur en Türkiye ; à défaut, sa résidence habituelle ; à défaut, le lieu où l'exécution doit avoir lieu.

### Les sentences arbitrales étrangères relèvent-elles de la même procédure ?

Non. Les sentences arbitrales étrangères obéissent à un régime distinct, celui de la <b>Convention de New York de 1958</b>, à laquelle la Türkiye est partie ; les conditions diffèrent de celles de l'exequatur des décisions de justice.
