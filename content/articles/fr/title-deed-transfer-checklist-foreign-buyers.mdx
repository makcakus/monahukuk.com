---
title: "Transfert du titre de propriété en Turquie"
description: "Checklist avant le transfert du tapu : vérifications, paiement sécurisé, procuration et gestion des risques. Avocat à Antalya."
date: 2026-04-28
...
### Quelles vérifications dois-je effectuer le jour du transfert du titre de propriété ?

Le relevé actuel du registre foncier doit être examiné <b>de nouveau le jour du transfert</b> ; une hypothèque, une saisie ou une mesure conservatoire peut avoir été ajoutée depuis la recherche initiale. Il convient également de vérifier les dettes de taxe foncière et de taxe de propreté environnementale, les relevés de charges de copropriété, ainsi que les dettes d'abonnement en eau, électricité et gaz naturel.

### Quand dois-je payer le prix de vente ?

La méthode la plus sûre consiste à payer le prix <b>au moment du transfert du titre de propriété</b>. Deux méthodes sont utilisées : la remise au vendeur d'un chèque bloqué par la banque immédiatement après l'achèvement du transfert, ou un virement bancaire simultané sur le compte du vendeur, le justificatif étant présenté au bureau du cadastre.

### Est-il problématique d'indiquer un prix de vente inférieur sur le titre de propriété ?

Oui, cela ne doit pas être accepté. Bien qu'il soit parfois suggéré d'indiquer sur l'acte un montant inférieur au prix réel afin de réduire le coût des droits, cela entraîne pour l'acheteur de graves conséquences juridiques et fiscales.
