...
Non. Selon l'article 44/7 du Code de la propriété industrielle (SMK), l'enregistrement ne confère aucun droit exclusif au déposant. Toute personne qui produit un bien présentant les caractéristiques décrites dans l'enregistrement peut utiliser l'indication, sous réserve de se conformer aux conditions de contrôle. Sur ce point, l'indication géographique diffère fondamentalement du droit des marques.

### Pourquoi la distinction entre appellation d'origine et indication de provenance est-elle importante ?

Parce qu'elle détermine la discipline de production. Dans l'appellation d'origine, toutes les étapes de production doivent se dérouler dans l'aire géographique délimitée ; dans l'indication de provenance, il suffit qu'au moins l'une de ces étapes y soit réalisée. Le choix d'une catégorie inadéquate peut entraîner le rejet de la demande.

### Une coopérative de producteurs de la région d'Antalya peut-elle déposer une demande d'indication géographique ?

Oui. L'article 36 du SMK range expressément parmi les titulaires du droit de dépôt les coopératives habilitées à défendre les intérêts économiques de leurs membres. La demande doit être accompagnée des documents techniques établissant le lien du produit avec l'aire géographique.
