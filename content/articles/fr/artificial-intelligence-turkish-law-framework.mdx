---
title: "Intelligence artificielle et droit turc"
...
### Existe-t-il en Türkiye une loi propre à l'intelligence artificielle ?

Non. À la date de rédaction, aucune loi consacrée exclusivement à l'intelligence artificielle n'est entrée en vigueur. La pratique s'appuie sur la législation existante : <b>la loi sur la protection des données (KVKK)</b> pour la dimension des données personnelles, le <b>droit d'auteur</b> pour les productions et les données d'entraînement, et les règles de la <b>responsabilité délictuelle</b> pour les dommages.

### Puis-je contester une décision prise par une intelligence artificielle ?

Oui. Lorsqu'un système entièrement automatisé rend une décision défavorable à la personne concernée — refus d'une demande de crédit ou élimination lors de la présélection d'une candidature, par exemple —, la KVKK lui reconnaît le droit de <b>s'opposer à cette décision et d'exiger une intervention humaine</b>.

### Dois-je informer le client qu'il utilise un agent conversationnel ?

Oui. Le client a le <b>droit de savoir qu'il parle à un robot</b>. En outre, l'exactitude des informations fournies par le robot et la responsabilité qui en découle doivent être expressément réglées par contrat.
