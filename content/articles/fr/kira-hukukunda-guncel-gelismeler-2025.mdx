...
**Tendance observée en pratique** — La question de savoir si la demande de médiation vaut notification écrite au sens de l'article 353 du COT, et quel est son effet sur le délai d'introduction de l'action en expulsion, est débattue devant les cours d'appel régionales ; ce point n'a pas encore été tranché de manière définitive par la jurisprudence de la Cour de cassation. Les bailleurs qui craignent de perdre leur droit d'agir lors du renouvellement du bail ont donc intérêt, par prudence, à adresser la notification de l'article 353 du COT séparément de la demande de médiation, par écrit et dans le délai légal.
