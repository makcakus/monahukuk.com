...
### Dois-je recueillir un consentement explicite sur mon site de commerce en ligne ?

Dans le parcours de commande, les données du client peuvent être traitées sur le fondement de <b>la conclusion et de l'exécution du contrat</b>, sans consentement explicite. En revanche, pour un traitement <b>à des fins de marketing</b>, un consentement explicite distinct de la notice d'information est nécessaire.

### Que doit contenir la bannière cookies ?

La bannière doit expliquer quels cookies le site utilise, <b>distinguer cookies nécessaires et optionnels</b> et offrir à l'utilisateur un véritable choix. Une politique cookies détaillée doit figurer sur une page distincte.

### Utiliser Google Analytics présente-t-il un risque au regard de la protection des données ?

Des outils tiers tels que Google Analytics, Facebook Pixel et Hotjar traitent des données personnelles et les <b>transfèrent à l'étranger</b>. Ils doivent donc être expressément listés dans la politique cookies et reposer sur une base juridique conforme au régime des transferts hors du pays.
