...
This principle is set out directly in KVKK Article 12(2) itself and is consistently upheld in both administrative and judicial practice: a data controller's responsibility under KVKK continues in full when it uses third-party processors. Delegating the processing task does not transfer legal accountability.
