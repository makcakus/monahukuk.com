...
- **Surviving spouse** — when inheriting alongside descendants or parents, the spouse's entire statutory share is protected; when inheriting alongside grandparents (or with no other heirs), the protected share is three-quarters of the statutory share (Civil Code Art. 506/4).
