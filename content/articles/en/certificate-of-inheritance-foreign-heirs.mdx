...
Since 2011, notaries also have authority to issue a certificate of inheritance. This method:

- **Fast** (typically same day or within a few days),
- Lower cost,
...
When a foreign deceased or heirs are involved, notaries carefully review the file and refer to court when needed.
...
In countries party to the Hague Apostille Convention, **apostille** is applied by the competent authority where the issuing institution is located. Apostille:
...
The Turkish translation of the apostilled document must be done by a **sworn translator**; **notary certification** is often added too.
...
- Must be filed within a specific period from the deceased's death,
- Period can be extended for foreign heirs,
- Tax payment plan can be set.

Title transfer and bank account procedures cannot be completed without filing a tax declaration. Therefore, taking action within a specific period after death is essential.
...
a certificate of inheritance can be issued. Each heir may file their own petition; in this case, a separate certificate is issued in each one's name.
...
- The process is conducted by a lawyer or authorised person via **apostilled notarised power of attorney**,
- The power of attorney must specifically include authorities like "obtaining certificate of inheritance, title transfer, bank account procedures",
- If the power of attorney is drawn up in a foreign language, a Turkish translation must also be obtained.
...
The most common problem is documents to be obtained in the home country being incomplete or not meeting attestation requirements. A detailed document list must be prepared and tracked at the start of the process.
...
Each stage is subject to a separate procedure; the certificate of inheritance forms the foundation of all.
