...
The Turkish Civil Code (Türk Medeni Kanunu) gives the tapu registrar the power to correct simple writing errors directly — without any court order — in accordance with the rules set out in the Tapu Sicili Tüzüğü (Land Registry Regulation). Article 74 of that Regulation governs how such corrections are made in the main and auxiliary registers.
