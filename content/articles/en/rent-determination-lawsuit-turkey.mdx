---
title: "Rent Determination Lawsuit in Turkey: Market-Rate Rent"
...
Filing fees in rent determination cases are calculated on the **monthly rent difference** (the gap between the current rent and the new rent), not on the annual total. The Court of Cassation's 3rd Civil Chamber confirmed this principle expressly in a decision dated 25 November 2024 (Case No. 2024/969, Decision No. 2024/3820), holding that the court fee in lawsuits to determine monthly rent must be calculated on the difference between the newly determined monthly rent and the previously paid monthly rent, and that charging the fee on the annual rent difference is contrary to law. Correct fee calculation saves both parties unnecessary cost.
...
### For which lease agreements can a rent-determination action be brought?

Under Article 344/3 of the Turkish Code of Obligations, for lease agreements with a term of <b>more than five years or renewed after five years</b>, a party may ask the court to determine the amount to apply in the new rental period. This remedy cannot be used before the five-year period has elapsed.

### Is the rent set according to comparable properties in a rent-determination action?

A court-appointed expert examines comparable lease agreements to establish the market rate; however, the judge generally applies an <b>equitable reduction</b> to the amount the expert has determined. For that reason, the amount finally awarded often falls below the raw comparable figure.

### How is the court fee calculated for a rent-determination action?

The court fee is calculated on the <b>monthly</b> difference in rent claimed, not on the annual difference. This detail significantly lowers the cost of the action.
