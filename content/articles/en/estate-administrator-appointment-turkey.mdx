...
A separate but related provision applies when the identity of the heirs is unclear or contested. In that situation, the court must appoint a *kayyım* to protect the estate until the question of who inherits is resolved. Turkey's Court of Cassation (Yargıtay) has confirmed that when heirs are unknown, this appointment is mandatory, since an estate with uncertain heirs concerns the interests of multiple parties, including the Treasury (see the 8th Civil Chamber's decision of 16 March 2017, E. 2017/1164, K. 2017/3761).
...
You do not need a dispute to apply. Yargıtay has confirmed in multiple decisions that an estate administrator can be requested even when the heirs are on good terms; as the 10th Civil Chamber noted in its decision of 21 February 2024 (E. 2024/461, K. 2024/1609), an administrator can be appointed even where an heir has not joined the proceedings or given written consent, without any actual dispute among the heirs being required. Practical reasons foreign heirs commonly cite include:
