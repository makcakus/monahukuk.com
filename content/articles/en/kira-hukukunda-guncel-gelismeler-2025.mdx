...
| Issue | Risk | Safe Approach |
|-------|------|---------------|
| Mediation timing | Early application invalidated | Confirm the right has arisen first |
| Final minutes document | Photocopy rejected | Get a certified copy from the mediation office |
| TBK 353 notice | One-year period may lapse | Record mediation as written notice |
| Two-notice eviction | 5-day e-service lag | Build in the 5-day buffer |
| WhatsApp notice | Validity disputed | Use notary or registered mail |
| Family home commitment | Single spouse signature voidable | Both spouses must sign |
| Guarantee on renewal | Guarantor not automatically bound | Obtain fresh written consent |
