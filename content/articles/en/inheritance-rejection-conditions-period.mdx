...
The law prescribes a **three-month period** for inheritance rejection (Turkish Civil Code Art. 606). This period:

- Runs for **statutory heirs** from the date they learn of the deceased's death (or from later learning they are heirs, if they can prove this),
- Runs for **will-designated heirs** from formal notification of the testator's disposition,
- If the period passes without rejection, inheritance is **deemed accepted**.
