...
Where rent is denominated in a **foreign currency**, no change in rent is permitted for the first five years (TBK Art. 344). After that, the rules in paragraphs 1 and 3 apply. Note that foreign currency rental agreements in Turkey are also subject to currency control regulations.
...
Disputes arising from lease renewals made during the temporary cap period — particularly questions about whether supra-cap agreements are void and how the transition back to normal rules operates — have generated ongoing litigation in Turkish courts. The Yargıtay 3rd Civil Chamber resolved a related question in its decision of 10 March 2025 (E. 2024/1083, K. 2025/1439), issued to settle a split among the Regional Courts of Appeal: the grounds available in a rent determination action under TBK Art. 344 do not form the subject matter of a hardship-adaptation action under TBK Art. 138. Temporary increase caps and inflation-based claims are assessed under TBK Art. 344, while an adaptation action under TBK Art. 138 remains available in genuinely extraordinary circumstances (such as an earthquake or flood) that independently meet that article's own requirements.
