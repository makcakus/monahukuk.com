...
The **Hague Convention on the Civil Aspects of International Child Abduction** aims for the **swift return** of a child wrongfully removed from or retained outside their **habitual residence**. The Convention:
...
- Impose provisional travel ban for child,
...
### To which children does the Hague Convention apply?

The child must be <b>under 16</b>, must have their habitual residence in a State party to the Convention, and must have been wrongfully removed from, or retained away from, that habitual residence.

### Is it abduction to take a child on holiday and not bring them back?

Yes. Under the Convention, child abduction covers not only taking a child to another country but also <b>failing to return the child from a country to which they were taken for a trip</b>.

### Is the return of the child always mandatory?

No, there are three exceptions: return may be refused where more than a year has passed since the abduction and the child has settled into the new environment, where return would expose the child to a grave physical or psychological risk, or where a child who has attained sufficient maturity objects to being returned.
