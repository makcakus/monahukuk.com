...
description: "KVKK obligations of e-commerce businesses, cookie disclosure, explicit consent, and newsletter delivery. E-commerce compliance guide by an Antalya IT lawyer."
date: 2026-04-28
...
### Must I obtain explicit consent on my e-commerce site?

In the ordering process, customer data may be processed on the legal ground of <b>the conclusion and performance of the contract</b>, without explicit consent. For processing <b>for marketing purposes</b>, however, an explicit consent separate from the privacy notice must be obtained.

### What must a cookie banner contain?

The banner must explain which cookies the site uses, <b>distinguish between necessary and optional cookies</b> and give the user a genuine choice. A detailed cookie policy must appear on a separate page.

### Is using Google Analytics a risk under the data protection law?

Third-party tools such as Google Analytics, Facebook Pixel and Hotjar process personal data and <b>transfer it abroad</b>. They must therefore be listed expressly in the cookie policy and rest on a legal basis that complies with the regime for transfers abroad.
