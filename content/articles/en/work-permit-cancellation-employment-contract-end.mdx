...
### What happens to my work permit if I leave my job?

Termination of the employment contract for any reason also results in <b>the termination of the work permit</b>. Because the permit is tied to the employer and to a specific job, it does not remain in effect once the employment relationship ends.

### What must an employer do when dismissing a foreign employee?

When an employer dismisses a foreign employee holding a work permit, it has an obligation to <b>notify the Ministry of Labour and Social Security</b>. Failure to make this notification constitutes a separate violation.

### Can I work in a job other than the one for which the permit was granted?

No. <b>Working outside the job description</b> for which the permit was granted, operating outside the scope of activity, or also working for another company is treated as an unpermitted practice and results in the cancellation of the work permit.
