...
Open source component usage is critical in license compatibility; supplier's use of viral-licensed code like GPL can transfer risk to customer.
...
- Income ownership (who owns it, does customer have usage rights or full ownership?) must be clear.
