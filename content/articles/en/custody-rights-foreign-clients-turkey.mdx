...
description: "Foreign parents' rights in custody cases in Turkey, the best interests principle, contact rights, and removal of children abroad. Antalya family law guide."
date: 2026-04-28
category: Family Law
...
Under Turkish law, **mother's and father's rights over the child are equal**. Being a foreign national is not an obstacle to custody rights; however, it may create disadvantages in some practical matters. The court typically evaluates:
...
If the foreign parent **cannot stay long-term in Turkey for work reasons**, the court factors this in. In addition, the importance of the foreign parent for protecting the child's mother tongue and cultural identity is clear.
...
- **Joint custody**: In practice, courts may also award joint custody where the spouses are able to cooperate and it serves the child's best interests; there are Court of Cassation decisions to this effect. This is not, however, a rule courts apply by default in contested cases — it is an exceptional arrangement assessed on the facts of each case.
...
When custody is granted to one parent, the other has **right to establish personal relationship**. This right is exercised through:
...
- A court order can impose a travel ban on the child,
- For temporary trips, the other parent's **notarised consent** is required,
- Unilateral abduction attempts fall under **international child abduction** rules.

In practice, when the foreign parent requests to take the child to their home country, the Turkish court conducts careful balancing of both parents' rights.
...
Regardless of which parent gets custody, the other parent has an obligation to pay **child support (iştirak nafakası)**. Living abroad does not change this obligation for the foreign parent:

- An enforcement (tenfiz) procedure can be used to collect, within Turkey, alimony ordered by a foreign court,
...
### Does being a foreign national prevent me from obtaining custody?

No. Under Turkish law the rights of the mother and the father over the child are equal, and foreign nationality is no bar to custody. The only decisive criterion is <b>the best interests of the child</b>.

### I have custody — may I take the child abroad?

Even where custody has been awarded to one parent, taking the child out of the country as a rule requires <b>the other parent's consent</b>. Removing the child without consent may amount to international child abduction.

### Can a custody order be changed later?

Yes. Even after a custody order has become final, an <b>action to vary custody</b> may be brought if circumstances change.
