...
The key advantage is **limited liability**. In most circumstances, the parent's financial exposure is capped at the amount it invested as share capital. A limited şirket requires at least one shareholder and a minimum capital of 50,000 TL under the Turkish Commercial Code — it is flexible, fast to establish, and well-suited to small and medium-scale operations. An anonim şirket requires a minimum capital of 250,000 TL (since 1 January 2024, under Presidential Decision No. 7887; for non-public joint stock companies adopting the registered capital system the minimum initial capital is 500,000 TL) and a more formal governance structure; it is the standard vehicle for larger operations, regulated sectors such as banking or insurance, and situations where shares may eventually be offered publicly.
