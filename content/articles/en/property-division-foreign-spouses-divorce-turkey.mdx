...
- **Acquired property**: Property the spouse obtains through **work** or with earned values during the marriage. Items such as salary, rental income, social security agency benefits, compensation for losses preventing one's work fall in this category.
- **Personal property**: Property the spouse owned before marriage; property acquired during marriage **through gift or inheritance**; personal-use items; non-pecuniary compensation; values replacing personal property.
