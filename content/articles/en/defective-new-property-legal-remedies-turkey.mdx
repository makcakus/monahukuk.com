...
Yargıtay has consistently affirmed all four remedies in new-build disputes. If the issues extend to the title deed itself, the [title deed cancellation process in Turkey](/en/articles/title-deed-cancellation-lawsuit-turkey) is a separate but sometimes concurrent avenue.
