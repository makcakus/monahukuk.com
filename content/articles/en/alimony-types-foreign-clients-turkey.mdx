...
- Increase can be requested as child's developing needs.
...
- **Enforcement lawsuit** confers enforceability in that country,
...
Coercive imprisonment can be applied to foreign debtors in practice only when in Turkey; ineffective against debtors abroad. International recovery treaties then come into play.
