...
### What are the most common reasons work permit applications are rejected?

Five reasons stand out: failure to meet the required <b>local employment ratio</b> at the workplace, the wage to be paid to the foreign employee failing to meet the required multiple of the minimum wage, the workplace falling below the paid-in capital or gross sales threshold, missing translation/apostille for professional qualification documents, and an obstacle arising from the security investigation.

### Should I first apply to the Ministry against a rejection decision?

It is possible to apply to the Ministry requesting <b>reconsideration</b>. This route produces faster results for correctable reasons such as missing documents. In addition, the right to bring an action for annulment before the Administrative Court within the period set out in administrative procedure legislation remains reserved.

### Can I obtain a work permit if I have an entry-ban code?

Having an entry-ban code, a history of visa violations, or being regarded as objectionable from the standpoint of public security results in the rejection of the application. In such a case, the legal process for removing the entry-ban code must first be pursued.
