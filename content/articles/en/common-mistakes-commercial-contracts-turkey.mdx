...
The contracts companies sign in their daily operations — supply, service, distribution, lease, confidentiality, partnership — sit quietly in drawers before disputes arise; however, when a disagreement arises, every clause of the contract is examined in detail before a court. Years of observations from our Antalya law firm providing commercial contract services to companies show that even the best companies make common mistakes in contract preparation. This guide addresses mistakes we frequently encounter in commercial contracts and ways to avoid them.

## Mistake 1: Using Standard Templates

Many companies create new contracts by making small changes to **standard templates** downloaded from the internet or taken from another job. This approach:
...
A standard template can be used as a starting point; however, every contract must be **adapted to concrete business requirements**.
...
- Drafting the contract **bilingually** (Turkish + English) is beneficial,
...
Preparing the Turkish text of the contract through a sworn translator and review by both parties' legal counsel is standard practice.

## Mistake 7: Skipping Confidentiality Provisions

For trade secrets, customer information, and technical information, **confidentiality provisions** must be an integral part of the contract. Common gaps:
...
Where to go when a dispute arises must be predetermined:
...
Whether the person signing the contract is authorised to represent the company must be verified. Contracts signed by an unauthorised person may not bind the company; special approval may be sought or the contract may be considered invalid.
...
- Right to terminate if it continues for a specific period
...
### What is the commonest mistake in a commercial contract?

Using a <b>standard template</b> that has not been adapted to the deal. A text downloaded from the internet or taken from another transaction does not reflect the parties' actual performance structure, the allocation of risk or sector-specific requirements. When a dispute arises, the points most fought over are precisely the items left blank or copied in the template: payment terms, delivery and acceptance, limitation of liability, termination and the competent court.

### How should payment terms be drafted?

Concretely and measurably. Instead of a vague 'payable on completion of the work', the contract should set out separately <b>the criterion for completion</b>, <b>the event after which the invoice is to be issued and within how many days</b>, <b>the payment due date</b>, <b>the default interest rate</b> and <b>the consequences of default</b>. Where both parties are traders, <b>the interest rate is freely determined</b> under Article 8 TTK; but to use that freedom the rate must be expressly agreed in the contract.

### May a limitation of liability be included in the contract?

As a rule yes, but within limits. Under Article 115 of the Code of Obligations <b>an agreement made in advance that the debtor will not be liable for its gross fault is absolutely void</b>; where the matter concerns a service, an activity requiring expertise or a licensed profession, a limitation even for slight fault may also be void. In addition, clauses excluding or narrowing liability in advance are invalid in the law of carriage under Article 854 TTK and in carriage by sea under Article 1243 TTK.

## Legal Support

For commercial contract preparation, negotiation, and dispute management in Antalya, **MONA HUKUK** provides comprehensive support to companies. Solid contract drafting from the start prevents future disputes and minimises the company's operational risks. With professional legal support, we make uncertainties predictable; ensuring business relationships are built on solid ground.
