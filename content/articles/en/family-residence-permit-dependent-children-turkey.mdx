...
In a decision dated 25 November 2020 (Case No. 2016/15370, Decision No. 2020/5398), the Danıştay's (Council of State) 10th Chamber held that where a document required by law from the sponsor — in that case, a criminal record certificate — is not submitted within the deadline set by the migration authority, the migration authority is bound to reject the application; it cannot treat the conditions as satisfied and approve the application regardless. Responding promptly to any document request is therefore essential.
