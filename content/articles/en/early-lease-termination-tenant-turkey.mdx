...
description: "What happens when a tenant in Turkey needs to leave before the lease ends? Learn your rights and obligations under Turkish law before breaking a rental contract."
date: 2026-06-11
category: Rental Law
...
2. **Hand over the keys formally**, preferably with a written record signed by both parties showing the date and condition of the property. Yargıtay has held that until the keys are returned, the tenant is presumed to be in possession — and therefore liable for rent.
