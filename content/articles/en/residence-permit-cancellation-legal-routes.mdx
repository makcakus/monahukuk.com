...
### Under what circumstances is a residence permit cancelled?

The main grounds are: the ground on which the permit was based has ceased to exist; a permit whose term has expired is not renewed; a lengthy stay abroad; a false statement or forged document in the application; a criminal record of a certain gravity; grounds of public order or security; and, for a family residence permit, a finding that the marriage is not genuine.

### If I divorce, is my residence permit automatically cancelled?

Because the family residence permit rests on the marital union, the ending of the marriage removes the condition on which the permit was based and constitutes a ground for cancellation. For that reason, alternative types of permit should be assessed early during the divorce process.

### What happens if I do not renew my permit?

Failure to renew a residence permit whose term has expired is an <b>automatic ground for cancellation</b>. Filing the renewal application within the time limit prevents consequences that are difficult to correct afterwards.
