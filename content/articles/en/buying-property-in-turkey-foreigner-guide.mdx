...
### What should I do first to buy an apartment in Türkiye as a foreigner?

Two administrative steps come before any payment: obtaining a <b>Turkish tax number</b> and opening a bank account in Türkiye. The purchase price must in principle be transferred through the banking system.

### Which records should be checked for the property I intend to buy?

At the land registry: whether the seller is genuinely the owner, and whether the property carries a mortgage, attachment, annotation or other encumbrance. At the municipality: the occupancy permit (habitation certificate), the status of the building licence and any zoning-amnesty record. It must also be confirmed that the property shown to you is the same one registered in the title deed.

### What does the military-zone check mean?

The Land Registry Directorate forwards the foreign buyer's acquisition request to the relevant authorities to verify whether the property lies within a <b>military prohibited zone or a security zone</b>. A negative result prevents the transfer from taking place.
