...
### What is the maximum amount a security deposit can be?

Under TBK Article 342/1, the security deposit that may be requested from the tenant may not exceed <b>the equivalent of three months' rent</b>. Any demand above this amount is contrary to law.

### Is depositing the security deposit in a bank mandatory?

Yes. The law requires the security deposit to be kept <b>in a time savings account in the tenant's name at a bank</b>. Although holding it in cash is common in practice, it is unlawful, and a tenant raising this in court can result in an outcome against the landlord.

### What can I do if the landlord doesn't return the deposit?

Under TBK Article 342/3, if the landlord does not give the bank <b>written notice within three months</b> of the termination of the lease that they are asserting a claim over the security, the bank is obliged, upon the tenant's request, to return the security to the tenant.
