...
### Should one prefer a share sale or an asset sale?

It depends on the appetite for risk. In a <b>share sale</b> the company's legal personality stays the same: contracts, licences and employees continue automatically, but <b>all past debts and exposures also remain in the company</b>. In an <b>asset sale</b> the buyer picks only the assets it wants; in return, under Article 202 of the Code of Obligations, <b>a person who takes over a body of assets is jointly and severally liable with the transferor for its debts for two years</b>. Liability for employment claims also arises on a transfer of workplace under Article 6 of the Labour Law.

### Why is due diligence carried out?

So that the buyer really knows what it is buying. The review runs on three axes: <b>legal</b> (articles of association, shareholding structure, pending litigation and enforcement proceedings, commercial contracts, intellectual property, permits and licences, data-protection and environmental compliance), <b>financial</b> (financial statements, tax and social security position, receivables and payables, banking relations) and <b>operational</b> (workforce, supply chain, production). The findings shape both the price and the representations, warranties and indemnities in the share purchase agreement.

### Is Competition Authority clearance required for a transfer of a company?

Yes, if the thresholds are exceeded. Under Article 7 of Law No. 4054 and Communiqué No. 2010/4 of the Competition Board, where in a merger or acquisition the parties' Turkish turnovers exceed the prescribed thresholds, <b>the transaction does not become legally valid unless clearance is obtained from the Competition Board</b>. Depending on the sector, approval may also be needed from the banking regulator (BDDK), the capital markets board (SPK), the energy regulator (EPDK) or the telecoms authority (BTK). These approvals are among the conditions to be satisfied before closing.
