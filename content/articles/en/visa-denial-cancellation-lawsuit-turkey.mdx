...
### Can I file a lawsuit against a visa denial?

Yes. A visa denial is an administrative act; it can be reviewed both procedurally and substantively. The lawsuit is filed before the <b>Administrative Court</b>, within the period set out in administrative procedure legislation, together with a request for a stay of execution.

### Why might my visa application have been rejected?

The most common reasons are: incomplete submission of the requested documents, doubts about the applicant's means of subsistence for the intended period in Turkey, previous visa violations, an entry-ban (tahdit) code in the system, an assessment relating to public order or security, false statements or documents, and previously rejected applications.

### Is it worth applying for a new visa while I have an entry-ban code?

A visa application by a foreigner with an entry-ban code is <b>automatically rejected</b>. For this reason, the process for removing the entry-ban code must be pursued before submitting a new application.
