...
This list is exhaustive. Relatives not named in the statute and with no legal support obligation — such as a fiancé(e) — fall outside it, and claims based on their needs are rejected. A sibling is a partial exception: as the Court of Cassation's (Yargıtay) 6th Civil Division held in its decision of 24 November 2014 (E. 2014/12439, K. 2014/12928), a claim based on a sibling's need can only succeed if it is proven that the landlord is legally obliged to support that sibling under Article 364 of the Turkish Civil Code; absent that proof, a sibling-need claim is likewise rejected.
...
As the Court of Cassation's 3rd Civil Division held in its decision of 21 April 2021 (E. 2021/2159, K. 2021/4476), the need must be **genuine, sincere and compelling**, and it must continue to exist throughout the litigation, not merely at the time of filing. Practical implications:

- A temporary need that does not persist, or an abstract need that may only arise at some point in the future, is not sufficient — the landlord cannot terminate the lease simply by stating that the property "might" be needed one day.
...
### By when must an eviction action based on the landlord's own need be brought?

In leases for a fixed term the action must be brought within <b>one month</b> of the end of the contractual term. In leases of indefinite duration a notice of termination is given first; the action must again be brought within one month of the expiry of the statutory periods relating to that notice. If the period is missed, the action is dismissed on procedural grounds.

### I have just bought the property — can I evict the tenant for my own need?

Yes. Under Article 351 of the Code of Obligations the new owner must notify the tenant in writing within <b>one month</b> of acquiring the property and may then bring an eviction action <b>six months</b> later. If no notice is given, this route is closed.

### After evicting a tenant for my own need, to whom may I let the property?

A landlord who has evicted a tenant by court order may not, without just cause, let the property to anyone other than the former tenant for <b>three years</b>. Breaching that prohibition gives rise to an obligation to compensate the former tenant's loss.
