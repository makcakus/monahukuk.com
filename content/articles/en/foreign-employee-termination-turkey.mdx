...
### Does a foreign employee have the same rights as a Turkish employee?

Yes. Under Turkish law a foreign employee has <b>equal rights</b> with a Turkish employee as a matter of labour law: the same rules on the employment contract, the same termination regime and the same entitlements to severance apply.

### What is the difference between a valid reason and a just cause?

A <b>valid reason</b> is a concrete and reasonable ground based on the employee's incapacity, conduct or the requirements of the undertaking, and it requires termination with notice. <b>Just cause</b> arises from seriously culpable conduct such as theft, a grave breach of discipline or unauthorised absence, and it allows immediate termination.

### What happens to the work permit of a dismissed foreign employee?

A foreign employee's work permit is tied to the employment relationship: once the employment contract ends, <b>the work permit as a rule ceases to be valid</b>. Residence and work status must therefore be regularised promptly after the termination.
