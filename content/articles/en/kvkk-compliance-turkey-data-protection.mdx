...
### Which businesses does the KVKK cover?

The Turkish Personal Data Protection Law (KVKK) covers <b>all natural and legal persons</b> who process personal data; there is no exemption based on the size of the business. Personal data means any information relating to an identified or identifiable natural person.

### Am I obliged to register with VERBİS?

Data controllers above a certain size must register with the <b>Data Controllers Registry Information System (VERBİS)</b>. Those required to register with VERBİS must also prepare a <b>Personal Data Retention and Destruction Policy</b>.

### What should I do if I suffer a data breach?

Where a data breach such as a cyberattack or a leak occurs, the data controller must <b>notify the Authority as soon as possible</b> and <b>inform the data subjects concerned</b>.
