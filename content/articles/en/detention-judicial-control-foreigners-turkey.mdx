...
### Does being a foreigner increase my chances of being remanded in custody?

In practice, <b>the risk of flight</b> is a ground frequently invoked for the detention of foreign suspects. That is not, however, an automatic consequence: the courts assess where the passport is held and the person's residence, family and employment ties in Türkiye. Judicial control — in particular a <b>ban on leaving the country</b> — may be considered sufficient in most cases.

### What measures can be applied instead of detention?

Under the principle of <b>proportionality</b>, detention may not be ordered where the result sought can be achieved by a lighter measure. The obligations in Article 109 of the Code of Criminal Procedure are used for this purpose, chiefly <b>judicial control</b> (ban on leaving the country, duty to report and sign) and <b>bail</b>.

### How does a detained foreigner's right to see a lawyer work?

The right to confer with a lawyer is fundamental: it includes a meeting <b>before any statement is taken</b>, a <b>private meeting free of supervision</b>, and, where the person lacks means, the assignment of defence counsel by the bar. A free interpreter is also provided for those meetings.
