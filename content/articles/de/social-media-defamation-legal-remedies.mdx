...
### Ich wurde in sozialen Medien beleidigt — kann ich sowohl ein Strafverfahren als auch eine Schadensersatzklage einleiten?

Ja. Das Strafverfahren und der Zivilprozess können unabhängig voneinander betrieben werden. Im Strafverfahren kann die Straftat der Beleidigung oder üblen Nachrede verfolgt werden; im Zivilverfahren kann wegen Verletzung von Ehre und Ansehen <b>immaterieller Schadensersatz</b> und wegen Schädigung des geschäftlichen Rufs und Kundenverlusts <b>materieller Schadensersatz</b> verlangt werden.

### Ist es möglich, eine Person mit einem anonymen Konto zu identifizieren?

Schwierig, aber möglich. Durch Gerichtsbeschluss können von der Plattform die Registrierungsdaten des Nutzers, die IP-Adresse sowie die verwendete E-Mail-Adresse oder Telefonnummer angefordert werden. In der Türkei gibt es auf die Verfolgung digitaler Spuren spezialisierte <b>Staatsanwaltschaften für Computerkriminalität</b>.

### Kann ich die sofortige Entfernung des Inhalts erwirken?

Ja. Die verletzte Person kann eine <b>Zugangssperre</b> erwirken, um die weitere Verbreitung des Inhalts zu stoppen. Zudem kann im Rahmen des <b>Rechts auf Vergessenwerden</b> ein Antrag hinsichtlich alter, unwahrer oder nicht mehr relevanter Informationen gestellt werden.
