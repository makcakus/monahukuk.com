...
Der Danıştay (Staatsrat) — das oberste Verwaltungsgericht der Türkei — hat mit seiner 10. Kammer in ihrer Entscheidung vom 31.10.2022 (E. 2022/5408, K. 2022/4906) bestätigt, dass die Ablehnung eines Antrags auf humanitäre Aufenthaltserlaubnis Gegenstand einer Anfechtungsklage vor den Verwaltungsgerichten sein kann und der verwaltungsgerichtlichen Kontrolle unterliegt. Dabei kann sowohl die Rechtmäßigkeit der Entscheidung als auch die Verhältnismäßigkeit eines verhängten Sicherheitscodes angefochten werden.
