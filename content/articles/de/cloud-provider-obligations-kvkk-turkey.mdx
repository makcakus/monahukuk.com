...
Cloud-Plattformen gehören heute zum Alltag vieler Unternehmen in der Türkei — ob SaaS-Tools, Remote-Speicher oder Infrastrukturservices. Was dabei häufig übersehen wird: Sobald personenbezogene Daten über einen Cloud-Anbieter fließen, greift das türkische Datenschutzgesetz (Kişisel Verilerin Korunması Kanunu, kurz KVKK) automatisch. Daraus entstehen konkrete rechtliche Pflichten — sowohl für das Unternehmen als auch für den Cloud-Anbieter. Dieser Grundsatz ist unmittelbar in Art. 12 Abs. 2 KVKK verankert und wird in der Verwaltungs- und Gerichtspraxis beständig angewandt: Die Beauftragung externer Auftragsverarbeiter lässt die Verantwortung des Datenverantwortlichen nach dem KVKK uneingeschränkt bestehen.
...
Dieser Grundsatz ist unmittelbar in Art. 12 Abs. 2 KVKK geregelt und wird in der Verwaltungs- und Gerichtspraxis beständig aufrechterhalten.
