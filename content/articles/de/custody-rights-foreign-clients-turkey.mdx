...
- **Gemeinsame Sorge**: In der Praxis können Gerichte auch gemeinsame Sorge anordnen, wenn die Ehegatten kooperieren können und dies dem Kindeswohl dient; entsprechende Entscheidungen des Yargıtay liegen vor. Dies ist jedoch keine Regel, auf die Gerichte in streitigen Verfahren von sich aus zurückgreifen, sondern eine Ausnahmeregelung, die anhand der Umstände des Einzelfalls beurteilt wird.
...
### Steht die ausländische Staatsangehörigkeit dem Sorgerecht entgegen?

Nein. Im türkischen Recht sind die Rechte von Mutter und Vater über das Kind gleich, und die ausländische Staatsangehörigkeit steht dem Sorgerecht nicht entgegen. Einziger maßgeblicher Maßstab ist <b>das Kindeswohl</b>.

### Ich habe das Sorgerecht — darf ich das Kind ins Ausland bringen?

Auch wenn das Sorgerecht einem Elternteil allein zusteht, bedarf die Ausreise des Kindes grundsätzlich der <b>Zustimmung des anderen Elternteils</b>. Ein Verbringen ohne Zustimmung kann internationale Kindesentführung darstellen.

### Kann eine Sorgerechtsentscheidung später geändert werden?

Ja. Auch nach Rechtskraft der Sorgerechtsentscheidung kann bei veränderten Umständen eine <b>Klage auf Abänderung des Sorgerechts</b> erhoben werden.
