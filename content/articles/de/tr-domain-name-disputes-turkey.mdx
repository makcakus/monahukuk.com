...
**Dritte Bedingung:** Die Domain muss in böser Absicht registriert worden sein oder bösgläubig genutzt werden. Die 11. Zivilkammer des Yargıtay wertet die Registrierung einer Domain, die eine bekannte Marke identisch übernimmt, als Markenverletzung. So entschied die Kammer in ihrer Entscheidung vom 03.05.2023 (E. 2023/2298, K. 2023/2642), dass die Registrierung der Domain „halkbank.istanbul" — die die bekannte Marke Halkbank identisch übernahm — und ihr anschließender Verkauf an einen Dritten eine Verletzung des Markenrechts darstellten (in der Entscheidung wurde auf den damals geltenden Art. 9 der Verordnung Nr. 556 angewandt, dessen Regelungsgehalt heute den Art. 7 und 29 des Gesetzes Nr. 6769 über gewerbliches Eigentum entspricht).
...
Die Registrierung einer bekannten Marke zum Zweck des gewinnbringenden Weiterverkaufs, die Nutzung der Domain zur Kundenumleitung oder die gezielte Blockierung des Markteigentümers sind anerkannte Beispiele. Auch die spätere Übertragung bzw. der Verkauf der streitigen Domain an Dritte hat der Yargıtay als Markenrechtsverletzung gewertet (Yargıtay, 11. Zivilkammer, Entscheidung vom 03.05.2023, E. 2023/2298, K. 2023/2642).
