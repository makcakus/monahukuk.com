...
### Welche Aufenthaltserlaubnis erhält ein mit einem türkischen Staatsangehörigen verheirateter Ausländer?

Die <b>Familienaufenthaltserlaubnis</b>. Der Zusammenführende kann ein türkischer Staatsangehöriger oder ein rechtmäßig in der Türkei lebender Ausländer sein; die Erlaubnis wird für den ausländischen Ehegatten und die unterhaltsberechtigten Kinder des Zusammenführenden erteilt.

### Was geschieht mit meiner Familienaufenthaltserlaubnis im Fall einer Scheidung?

Da die Familienaufenthaltserlaubnis auf der ehelichen Gemeinschaft beruht, wird sie mit der Beendigung der Ehe in der Regel widerrufen. In dieser Lage sollten die Möglichkeiten eines Wechsels zu einer anderen Art von Aufenthaltserlaubnis zügig geprüft werden.

### Wird die Zeit mit einer Familienaufenthaltserlaubnis bei der Einbürgerung angerechnet?

Ja. Zeiten, die mit einer Familienaufenthaltserlaubnis in der Türkei verbracht werden, werden auf die für den Antrag auf die türkische Staatsangehörigkeit erforderliche Aufenthaltsdauer angerechnet.
