...
Eine umfangreiche, speziell auf Escrow-Vereinbarungen zugeschnittene Rechtsprechung hat sich in der Türkei bislang noch nicht herausgebildet. Türkische Gerichte setzen jedoch Quellcode-Herausgabepflichten aus Lizenz- und Wartungsverträgen beständig nach den allgemeinen Grundsätzen des Obligationenrechts durch: So hat die 11. Zivilkammer des türkischen Kassationshofs (*Yargıtay 11. Hukuk Dairesi*) in ihrer Entscheidung vom 10.11.2015 (E. 2014/16892, K. 2015/11775) die Erfüllung einer im Vertrag ausdrücklich vereinbarten Pflicht zur Quellcode-Herausgabe sowie die Einziehung der bei Verletzung dieser Pflicht vereinbarten Vertragsstrafe bestätigt. Diese Rechtsprechung zeigt: Entscheidend für den Erfolg solcher Ansprüche vor Gericht ist, dass die Auslösebedingungen und die Herausgabepflicht im Vertrag schriftlich und eindeutig geregelt sind.
...
Urheberschaft und Rechteübertragung sind zentrale Fragen. Nach FSEK m. 8 ist der Schöpfer des Werks dessen Urheber. Bei Softwareentwicklern in einem Angestelltenverhältnis gehen die Nutzungsrechte mangels abweichender Vereinbarung auf den Arbeitgeber über (m. 18/2). Bei selbstständig beauftragten Entwicklern — dem in der Türkei häufigen Modell — muss die Rechteübertragung nach FSEK m. 52 ausdrücklich und schriftlich vereinbart werden. Eine mündliche Vereinbarung oder eine konkludente Übertragung reicht nach türkischem Recht nicht aus.

Für die Escrow-Vereinbarung bedeutet das: Es muss klar geregelt sein, ob der Verwahrer das Eigentum am Quellcode erhält, eine bedingte Lizenz bekommt oder lediglich ein Zugriffsrecht beim Eintreten eines Auslöseereignisses hat. Nach FSEK m. 68 sieht das Gesetz außerdem eine Entschädigung in dreifacher Höhe der vereinbarten Lizenzgebühr vor, wenn urheberrechtlich geschützte Rechte verletzt werden — ein wichtiger Hebel in Streitfällen. Zu [Software-Lizenzrisiken in der Türkei](/de/articles/software-license-agreements-legal-risks) und [Datenschutz-Compliance nach KVKK](/de/articles/kvkk-compliance-turkey-data-protection) stehen ergänzende Artikel zur Verfügung.

## Was eine solide Escrow-Vereinbarung enthalten sollte

In der Praxis werden sowohl tatsächlich bei einer Bank hinterlegte Quellcodes als auch von den Parteien als „Protokoll zur Quellcode-Übergabe, Sicherheit und Verantwortlichkeit für Inhalte" bezeichnete Vertragsanhänge als Elemente einer gültigen Escrow-Regelung anerkannt, sofern Auslösebedingungen und Übergabeverfahren klar und schriftlich definiert sind. Unter Berücksichtigung der Geschäftspraxis und der allgemeinen Grundsätze des Vertragsrechts sollte eine funktionsfähige Software-Escrow-Vereinbarung Folgendes abdecken:
...
Ja. Türkische Gerichte erkennen Quellcode-Herausgabepflichten, die im Hauptlizenzvertrag oder in einem dazugehörigen Anhang ausdrücklich geregelt sind, als rechtsverbindlich an und können bei Verletzung auf Erfüllung erkennen. Ein eigenständiger Dreiecksvertrag mit einer Bank oder einem Notar als Verwahrer liefert in der Praxis jedoch verlässlichere Ergebnisse.

### F: Was passiert, wenn der Anbieter die Hinterlegung verweigert?
Der Kunde kann auf Erfüllung und Schadensersatz klagen. Nach FSEK m. 68 gewährt das Gesetz bei Urheberrechtsverletzungen einen Anspruch auf das Dreifache der vereinbarten Lizenzgebühr. In Antalya werden geistige Eigentumsstreitigkeiten von spezialisierten Handelsgerichten behandelt.
