...
### Auf welche Falle stößt man in SaaS-Verträgen am häufigsten?

Auf Klauseln zur <b>automatischen Verlängerung</b>. Wird die für die Kündigung vorgesehene Frist versäumt, verlängert sich der Vertrag von selbst um eine weitere Laufzeit. Die im Vertrag festgelegte Kündigungsfrist muss in den Kalender eingetragen werden.

### Wem gehört das geistige Eigentum an speziell entwickelter Software?

Dies ist ein Thema, das Streitigkeiten hervorruft, sofern es nicht ausdrücklich im Vertrag geregelt ist. Die Individualentwicklung von Software wird eher im Zusammenhang mit einem <b>Werkvertrag</b> als mit einem reinen Lizenzvertrag beurteilt; ob die Rechte auf den Kunden übertragen werden, muss im Text ausdrücklich festgehalten werden.

### Sind meine Daten bei der Zusammenarbeit mit einem SaaS-Anbieter sicher?

Nicht, sofern dies nicht ausdrücklich im Vertrag geschützt ist. Der wichtigste Punkt bei SaaS-Verträgen ist die Absicherung der <b>Rechte des Kunden an den eigenen Daten</b> sowie des Rechts, die Daten bei Vertragsende exportieren (mitnehmen) zu können. Zudem müssen Dienstgütezusagen (SLAs) und Haftungsbeschränkungsklauseln sorgfältig geprüft werden.
