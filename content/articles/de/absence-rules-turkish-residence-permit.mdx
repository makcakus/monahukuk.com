...
Das YUKK delegiert die konkreten Abwesenheitsgrenzwerte für kurzfristige Erlaubnisse an eine Durchführungsverordnung nach Artikel 33. In der Praxis erfassen die türkischen Einwanderungsbehörden die gesamten außerhalb der Türkei verbrachten Tage innerhalb eines Erlaubniszeitraums. Überschreitet man die zulässige Gesamtabwesenheit, kann die Verlängerung allein aus diesem Grund abgelehnt werden — unabhängig davon, ob alle anderen Voraussetzungen erfüllt sind. So bestätigte der Danıştay (Staatsrat) in einer Entscheidung seiner 10. Kammer vom 02.12.2020 (E. 2016/796, K. 2020/5657) die Nichtverlängerung einer kurzfristigen Aufenthaltserlaubnis eines Klägers, der innerhalb eines Jahres mehr als 120 Tage außerhalb der Türkei verbracht hatte; Einwände des Klägers gegen die Tageberechnung änderten daran nichts.
...
Ja. Ablehnungen und Widerrufe von Aufenthaltserlaubnissen können vor den Verwaltungsgerichten angefochten werden. Stellt das Gericht einen Fehler bei der zugrunde liegenden Tageberechnung oder einen Verfahrensverstoß fest, kann die Klage zu Ihren Gunsten ausgehen.
