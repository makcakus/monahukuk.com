...
### Für welche Mietverträge kann eine Mietfestsetzungsklage erhoben werden?

Nach Art. 344 Abs. 3 des türkischen Obligationengesetzes kann bei Mietverträgen mit einer Laufzeit von <b>mehr als fünf Jahren oder die nach Ablauf von fünf Jahren erneuert werden</b>, verlangt werden, dass der für die neue Mietperiode geltende Betrag vom Gericht festgesetzt wird. Vor Ablauf der fünf Jahre kann dieser Weg nicht beschritten werden.

### Wird die Miete in der Mietfestsetzungsklage nach Vergleichsmieten bestimmt?

Ein gerichtlich bestellter Sachverständiger prüft vergleichbare Mietverträge und ermittelt so den Marktpreis; der Richter wendet auf den vom Sachverständigen ermittelten Betrag jedoch in der Regel einen <b>Billigkeitsabschlag</b> an. Deshalb bleibt der letztlich zugesprochene Betrag häufig unter dem rohen Vergleichswert.

### Wie wird die Gerichtsgebühr für die Mietfestsetzungsklage berechnet?

Die Gerichtsgebühr wird auf der Grundlage der geforderten <b>monatlichen</b> Mietdifferenz berechnet, nicht auf der Grundlage der jährlichen Differenz. Dies ist ein Detail, das die Prozesskosten erheblich senkt.
