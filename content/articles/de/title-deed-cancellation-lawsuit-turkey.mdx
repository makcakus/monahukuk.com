---
title: "Grundbuchberichtigung in der Türkei: Klage und Vorgehen"
description: "Rechtliche Grundlagen, Klagegründe und praktische Schritte zur Anfechtung eines fehlerhaften oder betrügerischen Grundbucheintrags in der Türkei."
date: 2026-06-12
...
Türkische Grundstückskäufe werden häufig über notarielle Vollmachten abgewickelt — ein Umstand, den unredliche Bevollmächtigte ausnutzen. Wer eine Vollmacht dazu benutzt, das Grundstück auf sich selbst, Verwandte oder eigene Gesellschaften zu übertragen, handelt vollmachtswidrig. Die Entscheidung der 1. Zivilkammer des Yargıtay vom 22.04.2021 (E. 2021/991, K. 2021/2509) stellte klar, dass auch eine Übertragungskette erfasst ist, bei der der im Namen des Erblassers handelnde Bevollmächtigte das Grundstück zunächst an eine mit ihm zusammenwirkende Mittelsperson überträgt, die es kurz darauf an den eigentlichen Zielkäufer weiterüberträgt — auch ein solches Vorgehen stellt einen Missbrauch der Vollmacht dar. Maßgeblich ist, ob der Bevollmächtigte im Interesse des Vollmachtgebers handelte.
...
### Unterliegt eine Klage auf Löschung und Neueintragung des Grundbuchtitels der Verjährung?

Nein. Klagen auf Löschung und Neueintragung des Grundbuchtitels unterliegen nicht der Verjährung; das Kassationsgericht hat diesen Grundsatz in zahlreichen Entscheidungen bestätigt. Zuwarten ist dennoch riskant, da sich das Ergebnis ändern kann, wenn die Immobilie an einen gutgläubigen Dritten übergeht.

### Unter welchen Umständen kann eine Klage auf Löschung des Grundbuchtitels erhoben werden?

Die wichtigsten Gründe sind: ein Scheingeschäft des Erblassers zur Vermögensverschiebung zu Lasten der Erben (<b>Erblasser-Simulation / muris muvazaası</b>), die Übertragung der Immobilie durch einen Bevollmächtigten unter Überschreitung seiner Vollmacht auf sich selbst oder Angehörige, das Fehlen der Geschäftsfähigkeit des Verkäufers im Zeitpunkt der Übertragung, die Verwendung gefälschter Urkunden und ein Katasterfehler.

### Was sollte ich unmittelbar nach Klageerhebung tun?

Im Grundbuch muss ein <b>Vermerk über eine einstweilige Verfügung</b> eingetragen werden. Da die Übertragung der streitgegenständlichen Immobilie an einen gutgläubigen Dritten den Erlass der Löschungsentscheidung verhindern könnte, ist dieser Vermerk der wichtigste Schritt im Verfahren.
