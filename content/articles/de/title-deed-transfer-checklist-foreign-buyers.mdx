...
### Welche Prüfungen sollte ich am Tag der Grundbuchübertragung vornehmen?

Der aktuelle Grundbucheintrag muss <b>am Tag der Übertragung erneut</b> geprüft werden; seit der ursprünglichen Recherche können eine Hypothek, eine Pfändung oder eine einstweilige Verfügung hinzugekommen sein. Ferner sollten Grundsteuer- und Umweltreinigungssteuerschulden, die Nebenkostenabrechnung der Wohnungseigentümergemeinschaft sowie ausstehende Wasser-, Strom- und Erdgasabonnementsschulden überprüft werden.

### Wann sollte ich den Kaufpreis zahlen?

Die sicherste Methode ist die Zahlung des Preises <b>bei der Grundbuchübertragung</b>. Zwei Vorgehensweisen sind gebräuchlich: die Übergabe eines von der Bank blockierten Schecks an den Verkäufer unmittelbar nach Abschluss der Übertragung oder eine zeitgleiche Überweisung auf das Konto des Verkäufers, wobei der Beleg dem Grundbuchamt vorgelegt wird.

### Ist es problematisch, im Grundbuch einen niedrigeren Kaufpreis anzugeben?

Ja, dies sollte nicht akzeptiert werden. Obwohl gelegentlich vorgeschlagen wird, im Kaufvertrag einen niedrigeren als den tatsächlichen Betrag anzugeben, um die Gebührenlast zu senken, hat dies für den Käufer ernsthafte rechtliche und steuerliche Folgen.
