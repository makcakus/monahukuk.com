...
### Wie viele Arten von Testamenten können in der Türkei errichtet werden?

Drei Arten: das <b>eigenhändige Testament</b>, das vor einem Notar oder einer befugten Amtsperson errichtete <b>öffentliche Testament</b>, sowie das nur in außergewöhnlichen Situationen zulässige <b>mündliche Testament</b>.

### Kann ich ein eigenhändiges Testament am Computer schreiben und unterschreiben?

Nein. Das eigenhändige Testament muss <b>vollständig</b> in der eigenen Handschrift des Erblassers verfasst sein; auch Datum und Unterschrift müssen handschriftlich angebracht werden. Ein am Computer geschriebener und unterschriebener Text ist in dieser Form nicht gültig.

### Unter welchen Umständen kann ein mündliches Testament errichtet werden?

Nur in <b>außergewöhnlichen Situationen</b> wie Krieg, Epidemie oder unmittelbarer Todesgefahr, und es kann mündlich vor zwei Zeugen errichtet werden. Unter gewöhnlichen Umständen kann auf diesen Weg nicht zurückgegriffen werden.
