...
### ¿Qué debo hacer primero para comprar un piso en Türkiye siendo extranjero?

Antes de cualquier pago hacen falta dos trámites administrativos: obtener un <b>número fiscal turco</b> y abrir una cuenta bancaria en Türkiye. El precio de compra debe transferirse, en principio, a través del sistema bancario.

### ¿Qué registros deben comprobarse sobre el inmueble que se va a comprar?

En el registro de la propiedad: si el vendedor es realmente el titular y si el inmueble soporta hipoteca, embargo, anotación u otras cargas. En el ayuntamiento: la licencia de primera ocupación, la situación de la licencia de obra y la eventual inscripción en la amnistía urbanística. Además debe confirmarse que el inmueble enseñado es el mismo que consta inscrito en el título.

### ¿Qué significa la comprobación de zona militar?

La Dirección del Registro de la Propiedad remite la solicitud de adquisición del extranjero a los organismos competentes para verificar si el inmueble se halla dentro de una <b>zona militar prohibida o zona de seguridad</b>. Un resultado negativo impide que se realice la transmisión.
