---
title: "Novedades en el Derecho de Arrendamientos en Turquía"
description: "Mediación obligatoria, dos avisos justificados e interpretación de los arts. 344-346 del TBK: las resoluciones más relevantes de 2024-2025 en arrendamientos."
date: 2026-05-12
...
Acudir a la mediación prematuramente puede no ser suficiente para cumplir el requisito procesal. La Sala 3.ª del Tribunal de Casación, en su resolución de 26.05.2025 (**E. 2025/1495, K. 2025/3048**), dictada para resolver la divergencia de criterios entre la Sala 4.ª de la Audiencia Provincial de Bursa y la Sala 55.ª de la Audiencia Provincial de Estambul, declaró que la expiración del plazo legal necesario para que nazca el derecho al desahucio es una condición previa al inicio del procedimiento de mediación. Si el arrendador presenta la solicitud de mediación antes de que ese derecho haya nacido, con el único objeto de ir quemando etapas, el tribunal puede declarar incumplido el requisito procesal.
...
**Práctica de las audiencias provinciales** — Iniciar el procedimiento de mediación no se considera suficiente por sí solo. Es imprescindible que el procedimiento se complete de conformidad con las normas procesales aplicables y que se extienda el acta final; de lo contrario, no se considera cumplido el requisito procesal.

**Tribunal de Casación, Sala 9.ª, resolución de 26.04.2022 (E. 2022/3398, K. 2022/5294)** — dictada para resolver una divergencia entre audiencias provinciales sobre el principio general aplicable al procedimiento de mediación — Si el procedimiento no puede completarse por una deficiencia imputable al propio mediador, no puede decirse que, respecto de la parte solicitante, no se haya cumplido el requisito procesal de "haber acudido a la mediación"; cuando el acta final no puede extenderse correctamente por causas ajenas a las partes, esa circunstancia no hace desaparecer el requisito procesal.
...
Las resoluciones del Tribunal de Casación ponen de manifiesto que las cláusulas penales en acuerdos de mediación sobre arrendamientos de vivienda son **nulas** conforme al artículo 346 del TBK. El artículo 346 prohíbe imponer al arrendatario cualquier obligación de pago distinta de la renta y los gastos accesorios. El hecho de que las partes hayan llegado a un acuerdo en mediación no permite sortear esta prohibición imperativa.

### El artículo 353 del TBK y el efecto de la mediación sobre los plazos

En virtud del artículo 353 del TBK, si el arrendador no realiza la notificación escrita en los plazos de caducidad aplicables a determinadas causas de desahucio, pierde el derecho al desahucio en el período siguiente.

**Tendencia en la práctica judicial** — Si la solicitud de mediación equivale o no a la notificación escrita del artículo 353 y qué efecto tiene sobre el plazo para interponer la demanda de desahucio es una cuestión debatida entre las audiencias provinciales, que todavía no ha sido resuelta de forma definitiva por el Tribunal de Casación. Los arrendadores que teman perder el derecho al desahucio en los períodos de renovación del contrato harán bien, por prudencia, en efectuar también la notificación del artículo 353 por escrito y dentro de plazo, de forma independiente a la solicitud de mediación.
...
Las disposiciones del TBK sobre protección del fiador son también aplicables al arrendamiento. En la fianza arrendaticia, la responsabilidad del fiador queda limitada, salvo disposición escrita en contrario, a la **fecha de vencimiento del contrato principal**. Cuando el contrato se prorroga o se renueva, no puede presumirse que la responsabilidad del fiador continúa automáticamente; es necesario obtener la conformidad escrita del fiador para el nuevo período. Los arrendadores que pasan por alto esta cuestión pueden encontrarse con que no pueden reclamar la deuda de renta al fiador.

---

## Procesos de Fijación y Revisión de la Renta

### Artículo 344 del TBK: ¿fijación o revisión?

El artículo 344 del TBK es una norma **especial** que regula la determinación de la renta en los arrendamientos de vivienda y locales con cubierta. Como adoptó la Sala 3.ª del Tribunal de Casación en su resolución de 10.03.2025 (E. 2024/1083, K. 2025/1439), dictada para resolver la divergencia entre distintas audiencias provinciales, los motivos de la acción de determinación/fijación de renta del artículo 344 no constituyen el objeto de la acción de adaptación contractual por excesiva onerosidad sobrevenida del artículo 138; se trata de dos tipos de acción que se valoran de forma independiente entre sí. Si el tipo de actualización de la renta no ha sido pactado por las partes o supera el IPC, entra en juego el artículo 344 y el tribunal puede fijar de nuevo la renta conforme a las condiciones del mercado. Para no dejar vencer los plazos al iniciar el procedimiento, es importante llevar un control de la fecha de inicio de cada período del contrato.
...
3. **Controle los plazos de notificación del artículo 353 del TBK.** Aunque la solicitud de mediación equivale a una notificación escrita, registre las fechas.
...
8. **No incluya cláusulas penales en el acuerdo de mediación.** Son nulas conforme al artículo 346 del TBK.
