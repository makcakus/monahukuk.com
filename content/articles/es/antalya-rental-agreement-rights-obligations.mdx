...
### ¿Debe el contrato de arrendamiento constar por escrito?

No. El Derecho turco no somete el arrendamiento a forma escrita; el contrato verbal es válido. No obstante, en la práctica se recomienda encarecidamente un texto escrito, porque facilita la prueba de la renta, la fecha de pago y las obligaciones de las partes.

### ¿Puede el arrendador desalojarme al terminar el plazo?

No. El mero vencimiento del plazo no es causa de desalojo; por regla general el contrato se renueva automáticamente. El arrendador sólo puede pedir el desalojo si concurre alguna de las causas enumeradas en la ley.

### ¿Quién paga la cuota de comunidad, el inquilino o el propietario?

Los gastos de uso de las zonas comunes (cuota de comunidad, portería y similares) se cobran normalmente al inquilino. En cambio, las grandes inversiones, como la sustitución del ascensor, corresponden al propietario.
