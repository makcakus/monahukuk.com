---
title: "Cómo Protegerse del Fraude en la Compra de Inmuebles"
...
### Si firmo un contrato y pago, ¿se convierte el inmueble en mío?

No. En el Derecho turco, la propiedad de un inmueble se adquiere <b>únicamente mediante la inscripción en el registro de la propiedad (tapu)</b>. Un contrato de compraventa, un justificante de pago, fotografías o declaraciones de testigos no transmiten por sí solos la propiedad.

### ¿Cuáles son los fraudes de tapu más frecuentes dirigidos a compradores extranjeros?

Destacan seis métodos: la venta mediante un poder notarial falsificado, la venta de un proyecto ficticio cuya construcción ni siquiera ha comenzado, la venta del mismo inmueble a dos personas, la ocultación de una hipoteca, embargo o medida cautelar sobre el inmueble, la falta de coincidencia entre la identidad del titular registral y la del vendedor, y la venta de una 'cuota' o 'derecho de uso' que no confiere propiedad real.

### ¿Es arriesgado pagar antes de la transmisión de la titularidad?

Sí, es el error más frecuente. El denominador común de los casos de fraude es que el pago se realizó antes de completarse la transmisión de la titularidad y que el proceso se llevó a cabo sin abogado.
