---
title: "Lista de Comprobación para la Transmisión del Título"
description: "Verificaciones finales en el día de la transmisión registral: garantía del pago, control del poder notarial y gestión del riesgo. El abogado de Antalya le guía."
date: 2026-04-28
...
### ¿Qué comprobaciones debo realizar el día de la transmisión del título de propiedad?

El registro actual de la propiedad debe examinarse <b>de nuevo el mismo día de la transmisión</b>; desde la investigación inicial puede haberse añadido una hipoteca, un embargo o una medida cautelar. Además, deben comprobarse las deudas por impuesto sobre bienes inmuebles y tasa de limpieza medioambiental, los registros de cuotas de la comunidad de propietarios, y las deudas pendientes de agua, electricidad y gas natural.

### ¿Cuándo debo pagar el precio de compra?

El método más seguro es pagar el precio <b>en el momento de la transmisión del título de propiedad</b>. Se utilizan dos vías: la entrega de un cheque bloqueado por el banco al vendedor inmediatamente después de completarse la transmisión, o una transferencia bancaria simultánea a la cuenta del vendedor, presentando el justificante en la oficina del registro de la propiedad.

### ¿Supone un problema hacer constar un precio de venta inferior en el título de propiedad?

Sí, no debe aceptarse. Aunque a veces se sugiere consignar en la escritura un importe inferior al precio real para reducir el coste de los aranceles, esto genera graves consecuencias jurídicas y fiscales para el comprador.
