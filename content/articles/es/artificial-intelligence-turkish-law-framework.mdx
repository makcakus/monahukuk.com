---
title: "Inteligencia Artificial y Derecho Turco"
...
### ¿Existe en Türkiye una ley específica sobre inteligencia artificial?

No. A la fecha de redacción no ha entrado en vigor ninguna ley dedicada en exclusiva a la inteligencia artificial. La práctica se apoya en la normativa vigente: <b>la Ley de Protección de Datos (KVKK)</b> en la dimensión de datos personales, la <b>normativa de propiedad intelectual</b> para los resultados y los datos de entrenamiento, y las reglas de <b>responsabilidad extracontractual</b> para los daños.

### ¿Puedo impugnar una decisión adoptada por inteligencia artificial?

Sí. Cuando un sistema totalmente automatizado dicta una decisión desfavorable para el interesado —por ejemplo, la denegación de una solicitud de crédito o el descarte en el cribado previo de una candidatura—, la KVKK le reconoce el derecho a <b>oponerse a esa decisión y exigir intervención humana</b>.

### ¿Debo informar al cliente de que está usando un chatbot?

Sí. El cliente tiene <b>derecho a saber que está hablando con un bot</b>. Además, la exactitud de la información facilitada por el bot y la responsabilidad derivada deben regularse expresamente en el contrato.
