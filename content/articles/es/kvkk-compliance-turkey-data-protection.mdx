---
title: "Cumplimiento KVKK: Guía de Protección de Datos en Turquía"
...
### ¿A qué empresas alcanza la KVKK?

La Ley turca de Protección de Datos Personales (KVKK) alcanza a <b>todas las personas físicas y jurídicas</b> que traten datos personales; no hay exención por el tamaño de la empresa. Son datos personales cualesquiera informaciones relativas a una persona física identificada o identificable.

### ¿Estoy obligado a inscribirme en VERBİS?

Los responsables del tratamiento que superen cierto tamaño deben inscribirse en el <b>Sistema de Información del Registro de Responsables (VERBİS)</b>. Quienes están obligados a inscribirse en VERBİS deben además elaborar una <b>Política de Conservación y Destrucción de Datos Personales</b>.

### ¿Qué debo hacer si sufro una brecha de datos?

Cuando se produce una brecha de datos —un ciberataque o una filtración—, el responsable debe <b>notificarlo a la Autoridad a la mayor brevedad</b> e <b>informar a los interesados afectados</b>.
